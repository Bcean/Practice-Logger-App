...
SECRET_KEY = 'django-insecure-ach6!&6@7^(f33#^n752og0htn5+u#$kl&9=9zrowf4!u&@=#@'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'practice_logger_db',  # The name of your database
        'USER': 'postgres',  # Your database user
        'PASSWORD': '24Crazy224Apple99!@',  # Your database password
